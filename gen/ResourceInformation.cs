...
namespace ConvertSupport
{
    ...
    public class ResourceInformation
    {
        ...
        public ResourceInformation(XElement resInfoElement, ConvertEnvironment resEnvironment)
        {
            ...
            outputFileFullPath = Regex.Replace(environment.OutputPath + @"\" + resInfoElement.Attribute(@"BinFile").Value, @"bin$", "xml");
        ...
        /// 构建元数据库
        /// </summary>
        private void ConstructMetadataLibrary()
        {
